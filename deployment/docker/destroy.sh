...
echo 'If docker listed any relevant resources to irida try rerunning ./destroy.sh. If it still fails to delete the resources then you will need to manually delete them.'
